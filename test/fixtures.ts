...
import MateriaERC20 from '@materia-dex/materia-contracts-core/build/ERC20.json'
...
export async function stakingRewardsFixture([wallet]: Wallet[]): Promise<StakingRewardsFixture> {
  ...
  const stakingToken = await deployContract(wallet, MateriaERC20, [expandTo18Decimals(1000000)])
